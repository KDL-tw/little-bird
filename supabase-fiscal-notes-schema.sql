...
-- Add fiscal note fields to admin_bills table
ALTER TABLE admin_bills ADD COLUMN IF NOT EXISTS fiscal_note_url TEXT;
ALTER TABLE admin_bills ADD COLUMN IF NOT EXISTS fiscal_note_status TEXT CHECK (fiscal_note_status IN ('Not Found', 'Found', 'Processing', 'Error')) DEFAULT 'Not Found';
ALTER TABLE admin_bills ADD COLUMN IF NOT EXISTS fiscal_note_last_checked TIMESTAMP WITH TIME ZONE;
ALTER TABLE admin_bills ADD COLUMN IF NOT EXISTS fiscal_note_agent_version TEXT;
