-- FISCAL NOTES SCHEMA (FIXED VERSION)
-- This extends the admin repository to store fiscal note data and AI analysis
-- Handles existing functions and triggers gracefully
...
-- Create triggers for updated_at (using unique names to avoid conflicts)
DO $$ 
BEGIN
